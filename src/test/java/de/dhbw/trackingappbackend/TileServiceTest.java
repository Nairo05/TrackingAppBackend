...
public class TileServiceTest {
    ...
    @Test
    public void testGetTileIdByCoordinates() {

        byte zoomLevel = 14;
        TileId horbTile = new TileId(8587, 5664, (byte) 14);
        ...
        for (double[] pos : posInsideTile) {
            assert(TileService.getTileIdByCoordinates(pos[0], pos[1], zoomLevel).equals(horbTile));
        }
    ...
    @Test
    public void testGetCoordinatesByTileId() {
        ...
        double[] posUl = TileService.getCoordinatesByTileId(new TileId(xHorb, yHorb, zoomLevel));
        double[] posUr = TileService.getCoordinatesByTileId(new TileId(xHorb + 1, yHorb, zoomLevel));
        double[] posLr = TileService.getCoordinatesByTileId(new TileId(xHorb + 1, yHorb + 1, zoomLevel));
        double[] posLl = TileService.getCoordinatesByTileId(new TileId(xHorb, yHorb + 1, zoomLevel));
