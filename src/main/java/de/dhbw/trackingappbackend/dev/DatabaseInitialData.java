...
public class DatabaseInitialData {
    ...
    public CommandLineRunner createTestData(UserRepository userRepository, LocationRepository locationRepository) {
        return (args) -> {
            ...
            Location loc1 = new Location(UUID.randomUUID().toString(), new Tile(0, 0, (byte) 14)); //, List.of("DE"));
            Location loc2 = new Location(UUID.randomUUID().toString(), new Tile(0, 1, (byte) 14)); //, List.of("DE"));
            Location loc3 = new Location(UUID.randomUUID().toString(), new Tile(1, 0, (byte) 14)); //, List.of("DE"));
            Location loc4 = new Location(UUID.randomUUID().toString(), new Tile(1, 1, (byte) 14)); //, List.of("DE"));
